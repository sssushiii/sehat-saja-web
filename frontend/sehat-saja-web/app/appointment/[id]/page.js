...
//         s.day === selectedDate.toLocaleDateString('id-ID', { weekday: 'long' })
//       )?.times || []
//     : [];

//   const handleSubmit = (e) => {
//     e.preventDefault();
//     alert(`Janji dengan ${doctor.title} pada ${selectedDate?.toLocaleDateString()} jam ${selectedTime} berhasil dibuat!`);
//   };
...
//                 <img src={`${doctor.image}`} alt={`${doctor.title}`} className="rounded-full mr-5 h-32 object-cover aspect-square object-top" />
//                 <div className="">
...
//               {selectedDate && (
//                 <div className="mb-10">
//                   <h2 className="text-xl font-semibold mb-4">Pilih Jam</h2>
...
//                   <h3 className="font-semibold text-lg mb-3">Ringkasan Janji Temu</h3>
//                   <div className="space-y-2 mb-5 text-gray-700">
//                     <p><span className="font-medium">Dokter:</span> {doctor.title}</p>
//                     <p><span className="font-medium">Tanggal:</span> {selectedDate.toLocaleDateString('id-ID', { weekday: 'long', day: 'numeric', month: 'long' })}</p>
//                     <p><span className="font-medium">Jam:</span> {selectedTime}</p>
//                   </div>
//                   <button
//                     type="submit"
...
//   const handleSubmit = (e) => {
//     e.preventDefault();
//     alert(`Appointment with ${doctor.title} on ${selectedDate?.toLocaleDateString()} at ${selectedTime} has been booked!`);
//   };
