...
import { doc, getDoc, collection, query, where, getDocs, writeBatch, updateDoc, limit } from "firebase/firestore";
  ...
  const handlePayNow = async (paymentId) => {
    try {
      ...
      if (paymentDoc.exists() && paymentDoc.data().appointmentId) {
        await updateDoc(doc(db, "appointments", paymentDoc.data().appointmentId), {
    ...
    <div className="space-y-6">
      ...
      {appointments.length === 0 ? (
        <div className="bg-white p-8 rounded-xl shadow text-center">
          ...
          <Link href="/doctors" className="mt-4 inline-block px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
            Book an Appointment
          </Link>
        </div>
      ) : (
            ...
            >
              ...
              <div className="mt-4 space-y-2 text-sm">
                ...
                <div className="pt-2">
                  ...
                  <p className="text-gray-600">{appointment.complaint || "Not specified"}</p>
                </div>
              </div>
        ...
        {!isEditing ? (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <p className="font-medium">{accountData.phone || "Not provided"}</p>
            </div>
            <div>
              <p className="text-sm text-gray-500">Date of Birth</p>
              <p className="font-medium">
                {accountData.birthDate ? formatDate(accountData.birthDate) : "Not provided"}
              </p>
            </div>
            <div>
                    ...
                    <div className="pt-2">
                      ...
                      <div className="bg-blue-50 p-3 rounded-lg">
                        <div className="flex items-center gap-2 text-sm">
                          ...
                          <span className="font-medium">{data.appointment.doctorName}</span>
                        </div>
          ...
          <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left ${
                activeView === "appointments" ? "bg-blue-100 text-blue-600" : "hover:bg-gray-100"
              } transition-colors`}
            >
              <FirstAid size={20} />
              Appointments
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left ${
                activeView === "payments" ? "bg-blue-100 text-blue-600" : "hover:bg-gray-100"
              } transition-colors`}
            >
              <Receipt size={20} />
              Payments
            ...
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-left ${
                activeView === "account" ? "bg-blue-100 text-blue-600" : "hover:bg-gray-100"
              } transition-colors`}
            >
              <User size={20} />
              Account
