...
import { onAuthStateChanged, signOut, EmailAuthProvider, reauthenticateWithCredential, updatePassword, updateProfile } from "firebase/auth";
...
export default function PatientDashboard() {
  ...
  const handlePayNow = async (paymentId) => {
    try {
      ...
      await fetchAllData(user.uid);
      alert("Payment completed successfully! You will receive payment instructions via email.");
    } catch (error) {
