    ...
    const unsubscribe = onAuthStateChanged(auth, async (currentUser) => {
      if (currentUser) {
        ...
        if (docSnapshot.exists()) {
          ...
          setUserRole(userData.role || "user"); // Set role dari Firestore
        } else {
          // Jika tidak ada data di Firestore, gunakan data dari auth saja
          setUser({
            ...currentUser,
...
//             name: userData.name || "",
//             phone: userData.phone || "",
//             // Gunakan photoUrl dari Firestore jika ada, jika tidak gunakan photoURL dari auth
//             photoUrl: userData.photoUrl || currentUser.photoURL || ""
//           });
//         } else {
//           // Jika tidak ada data di Firestore, gunakan data dari auth saja
