        ...
        try { 
            ...
            if (docSnap.exists()) {
                ...
                if (userData.role === 'doctor') {
                    ...
                    setError('Access denied: Only users with doctor role can login here.');
                }
            } else {
                        ...
                        <div className="second-left w-[75%] h-[85%] bg-white rounded-l-2xl px-[10%] py-[8%] tracking-wide">
                            <div className="signinform flex flex-col h-full">
                                ...
                                <div className="signin-title mb-4">
                                    <h1 className="font-semibold text-3xl">Sign In as Doctor</h1>
                                    <p className="font-light">Welcome back to SehatSaja, Doctor</p>
                                </div>
